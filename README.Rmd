...
Once your snakemake has been installed in a conda environment and activated you can navigate to the `workflows/` folder and run the following to execute the workflow: 
