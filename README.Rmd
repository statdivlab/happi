...
```
<span style="font-family:Arial; font-size:1.5em;"> a **H**ierarchical **Ap**proach to **P**angenomics **I**nference</span>

`happi` is an `R` package for modeling gene presence. ![happi Logo](/vignettes/logo.JPEG)
