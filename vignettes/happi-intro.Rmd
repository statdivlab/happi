...
We are interested in understanding whether the presence of a gene, let's choose this gene that encodes for `Ribosomal protein L27`, is more enriched (aka prevalent) in Saccharibacteria MAGs recovered from plaque samples versus tongue samples. 
