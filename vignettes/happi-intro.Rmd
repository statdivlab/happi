...
perm_test_result
```
Using `happi` we see that the p-value is larger when we compare the p-value from `happi` (p = 0.052) to the p-value using GLM-Rao (p = 0.006). 
